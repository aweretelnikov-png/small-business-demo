...
DEFAULT_INPUT_FILE = PROJECT_DIR / "data" / "raw" / "customers.csv"
...
def main(input_file: Path) -> None:
    ...
    logger.info(
        "Загрузка клиентов из %s завершена. Добавлено: %s. Пропущено: %s.",
        input_file.name,
        inserted_count,
        skipped_count,
    )
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Загрузка клиентов в PostgreSQL.")
